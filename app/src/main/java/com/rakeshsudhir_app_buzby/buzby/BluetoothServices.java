...
//IBinder mIBinder = new LocalBinder();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        //String deviceg = "00:04:3E:6B:2C:D0";
...
/*private synchronized void connected(BluetoothSocket mmSocket){
    ...
    private class ConnectBtThread extends Thread{
        ...
        public void run() {
            ...
            try {
                mSocket.connect();
                Log.d("service","connect thread run method (connected)"+mDevice.getName());
                ...
                try {
                    mSocket.close();
                    Log.d("service","connect thread run method ( close function)"+mDevice.getName());
    ...
    private class ConnectedBtThread extends Thread{
        ...
        public void write(byte[] buff){
            try {
                ...
                byte[] bb2 = new byte[]{0x1B,0x21,0x30};
                outS.write(bb2);
                outS.write(buff);
            } catch (IOException e) {
                e.printStackTrace();
    ...
    public void onDestroy() {
        ...
        preferenceConfig.writeBluetoothDeviceName("");
    }
}
